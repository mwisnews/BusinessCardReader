...
business card and returns them to the user.
...
This project requires JDK (Java Development Kit) which can be downloaded 
as Java SE 8 from http://www.oracle.com/technetwork/java/javase/downloads/index.html 
...
The output of the program should appear in a window below the code window. If implemented right, the ExampleOne.dat output
should read:
		Name: Mike Smith
		Phone: (410)555-1234
